...
const PLANS = [
  {
    ...
    price: "Free",
    period: "forever",
    description: "Start your journey. Your egg is already waiting.",
    creature: "🥚",
    features: [
      "1 companion persona",
      "Daily check-ins via Telegram",
      "1 active goal tracked",
      "Streak tracking",
      "Creature hatches on day 3",
      "Creature grows to Level 3",
    ],
    cta: "Start free",
    highlighted: false,
  },
  {
    ...
    price: "$4.99",
    period: "/month",
    description: "For students and individuals who show up every day.",
    creature: "🐉",
    features: [
      "All 3 companion personas",
      "WhatsApp + Telegram",
      "Unlimited goals tracked",
      "Full creature evolution",
      "Weekly aura card",
  ...
  },
  {
    ...
    price: "Custom",
    period: "",
    description: "For coaching businesses, gyms, and study cohorts.",
    creature: "🌍",
    features: [
      "Everything in Evolved",
      ...
      <div className="mx-auto max-w-[1400px] px-2.5 sm:px-6 lg:px-12">
        ...
        >
          ...
          <h2 className="mt-3 text-3xl font-bold text-[var(--color-baltic-sea-100)] md:text-4xl text-balance">
            Your creature is waiting
          </h2>
          <p className="mt-4 text-lg text-[var(--color-baltic-sea-400)]">
            Start free. Upgrade when Kira is ready to evolve.
          </p>
        </div>
            ...
            >
              ...
              <div className="p-6 lg:p-8">
                <div className="flex items-center gap-3 mb-1">
                  <span className="text-2xl">{plan.creature}</span>
        ...
        <p
          className={`text-center text-sm text-[var(--color-baltic-sea-500)] mt-10 transition-all duration-700 ${isVisible ? "opacity-100" : "opacity-0"}`}
          style={{ transitionDelay: "800ms" }}
        >
          No credit card required · Cancel anytime · Your creature hatches in 3 days
        </p>
      </div>
    </section>
  )
