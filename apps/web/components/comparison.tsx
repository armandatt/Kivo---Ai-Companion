              ...
              <tbody>
                {FEATURES.map((feature, i) => (
                  ...
                  >
                    ...
                    <td className="p-4 lg:p-6">
                      <FeatureCell value={feature.kubernetes as boolean | "partial"} isVisible={isVisible} delay={450 + i * 60} />
                    </td>
                    <td className="p-4 lg:p-6">
                      <FeatureCell value={feature.lambda as boolean | "partial"} isVisible={isVisible} delay={500 + i * 60} />
                    </td>
                  </tr>
                ))}
              </tbody>
